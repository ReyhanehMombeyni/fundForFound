        ...
        <div className="text-base text-gray-700">
          <ul className="flex flex-col gap-5 items-start">
            <li className="flex items-center justify-start gap-5">
              <span className="text-2xl text-gray-400"><FaCircleUser /></span>
              <p>My profile</p>
            </li>
            <li>
                <div className="flex items-center justify-start gap-5">
                    <span className="text-2xl text-gray-400"><BsFillArchiveFill /></span>
                    <p>My brands and organisations</p>
                    <span className="text-3xl text-gray-400"><IoAddCircleOutline /></span>
                </div>
                <ul className="pl-10 pt-3">
                    <li className="flex gap-2 items-center text-sm">
                        <span className="px-1 bg-blue-800 rounded-full text-blue-400">W</span>
                        <p>brand name</p>
                    </li>
                </ul>
            </li>
            <li className="flex items-center justify-start gap-5">
              <span className="text-2xl text-gray-400"><IoSettingsSharp /></span>
              <p>Setting</p>
            </li>
            <li className="flex items-center justify-start gap-5">
              <span className="text-2xl text-gray-400"><TbLogout /></span>
              <p>Log out</p>
            </li>
          </ul>
        </div>
